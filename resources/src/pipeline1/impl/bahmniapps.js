...
var getDeployScript = function(artifact) {
  ...
  deployScript.value = deployScript.value + "mvn deploy:deploy-file -DgroupId=net.mekomsolutions -DartifactId=" + artifact.name + " -Dversion=" + artifact.version + " -Dpackaging=" + artifact.extension + " -DrepositoryId=${NEXUS_REPO_ID} -Durl=${NEXUS_URL_bahmniapps} -Dfile=" + artifact.destFilename + "\n"
