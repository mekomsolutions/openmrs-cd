...
var getDeployScript = function() {
  ...
  deployScript.comments = "# Autogenerated script to deploy 'openmrsconfig' type of projects"
  deployScript.value = "nexus_envvars=$1 ; . $nexus_envvars\n"
  deployScript.value = deployScript.value + "mvn clean deploy -DskipTests -DaltDeploymentRepository=${NEXUS_REPO_ID}::default::${ARTIFACT_UPLOAD_URL_openmrsconfig}\n"
