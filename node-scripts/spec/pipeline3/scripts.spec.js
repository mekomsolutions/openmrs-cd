...
describe("Scripts", function() {
  ...
  it("should generate fetchArtifact() commands", function() {
    ...
    var expected =
      ...
      "\nmvn org.apache.maven.plugins:maven-dependency-plugin:3.2.0:copy -Dmdep.useBaseVersion -Dartifact=net.mekomsolutions:openmrs-distro-cambodia:1.1.0-SNAPSHOT:zip -DoutputDirectory=a_path" +
