...
/**
 * Main script of the 'maintenance OFF' stage.
 *
 */
...
const currentStage = config.getMaintenanceOffStatusCode();
...
if (!_.isEmpty(proxies)) {
  proxies.forEach(function(proxy) {
    script.body.push(
      scripts.remote(ssh, scripts[proxy.type].maintenance(false, proxy.value))
    );
  });
}
...
//
fs.writeFileSync(
  path.resolve(config.getBuildDirPath(), config.getMaintenanceOffScriptName()),
