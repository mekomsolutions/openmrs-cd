...
script.body.push(scripts.remote(ssh, scripts.initFolder(hostDir, ssh.user, false, ssh.group)));
...
if (process.env[config.varArtifactsChanges()] === "true") {
  ...
  script.body.push(
    scripts.remote(ssh, scripts.initFolder(hostArtifactsDir, ssh.user, false, ssh.group), true)
  );
