...
script.headComment = "# Autogenerated script for the CD instance destroy...";
script.body = [];
script.body.push("set -xe\n");

script.body.push(scripts.remote(ssh, deploymentScripts.stop(instanceDef)));

script.body.push(scripts.remote(ssh, deploymentScripts.remove(instanceDef)));
