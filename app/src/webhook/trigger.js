...
var triggers = JSON.parse(fs.readFileSync("/usr/share/jenkins/webhook_triggers.json", 'utf8'))
...
fs.writeFileSync(process.env.WORKSPACE + "/trigger.env", utils.convertToEnvVar(project))
fs.writeFileSync(process.env.WORKSPACE + "/trigger.json", JSON.stringify(project))
