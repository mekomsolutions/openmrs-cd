...
var getBuildScript = function() {
  ...
  buildScript.headComment =
    "# Autogenerated script to build 'bahmniconfig' type of projects";
...
var getDeployScript = function() {
  ...
  deployScript.headComment =
    "# Autogenerated script to deploy 'bahmniconfig' type of projects";

  deployScript.body = "nexus_envvars=$1 ; . $nexus_envvars\n";
  deployScript.body +=
    "mvn clean deploy -DskipTests -DaltDeploymentRepository=${NEXUS_REPO_ID}::default::${ARTIFACT_UPLOAD_URL_bahmniconfig}" +
    "\n";
