...
var getBuildScript = function() {
  ...
  buildScript.comments =
    "# Autogenerated script to build 'openmrsconfig' type of projects";

  buildScript.body = "mvn clean install\n";
...
var getDeployScript = function() {
  ...
  deployScript.comments =
    "# Autogenerated script to deploy 'openmrsconfig' type of projects";

  deployScript.body = "nexus_envvars=$1 ; . $nexus_envvars\n";
  deployScript.body +=
    "mvn clean deploy -DskipTests -DaltDeploymentRepository=${NEXUS_REPO_ID}::default::${ARTIFACT_UPLOAD_URL_openmrsconfig}\n";
